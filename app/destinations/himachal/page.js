...
const tours = [
  {
    title: "McLeodganj Himalayan Trekking Odyssey",
    dates: ["Dates on Request"],
    prices: ["₹8,999*", "₹7,499*"],
    image: "/img/himachal.jpg",
    duration: "2N3D",
    group: "Group Tour",
    link: "/trip-packages/mcleodganj-trekking",
  },
  {
    title: "Kasol Tosh Valley Untamed Journey",
    dates: ["Dates on Request"],
    prices: ["₹9,499*", "₹7,999*"],
    image: "/img/himachal.jpg",
    duration: "2N3D",
    group: "Group Tour",
    link: "/trip-packages/kasol-tosh",
  },
  {
    title: "Tirthan Valley Cascading Wonders Escape",
    dates: ["Dates on Request"],
    prices: ["₹9,999*", "₹8,499*"],
    image: "/img/himachal.jpg",
    duration: "2N3D",
    group: "Group Tour",
    link: "/trip-packages/tirthan-valley",
  },
  {
    title: "Manali Kasol Sissu Alpine Dream",
    dates: ["Dates on Request"],
    prices: ["₹12,999*", "₹10,999*"],
    image: "/img/himachal.jpg",
    duration: "3N4D",
    group: "Group Tour",
    link: "/trip-packages/manali-kasol-sissu",
  },
  {
    title: "McLeod Bir Tirthan Skyward Adventure",
    dates: ["Dates on Request"],
    prices: ["₹15,999*", "₹13,999*"],
    image: "/img/himachal.jpg",
    duration: "4N5D",
    group: "Group Tour",
    link: "/trip-packages/mcleod-bir-tirthan",
  },
];
