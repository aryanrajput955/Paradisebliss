...
const tours = [
  { title: "Gangtok Himalayan Mystic Retreat", dates: ["Dates on Request"], prices: ["₹12,499*"], image: "/img/sikkim2.jpg", duration: "3N4D", group: "Group Tour" },
  { title: "Sikkim Tsomgo Nathula Alpine Odyssey", dates: ["Dates on Request"], prices: ["₹18,999*", "₹16,499*", "₹2,500 Off"], image: "/img/sikkim2.jpg", duration: "4N5D", group: "Group Tour" },
  { title: "Pelling Kanchenjunga Serenity Escape", dates: ["Dates on Request"], prices: ["₹22,999*", "₹19,999*", "₹3,000 Off"], image: "/img/sikkim2.jpg", duration: "5N6D", group: "Group Tour" },
  { title: "North Sikkim Lachung Yumthang Paradise Trek", dates: ["Dates on Request"], prices: ["₹25,499*", "₹22,499*", "₹3,000 Off"], image: "/img/sikkim2.jpg", duration: "6N7D", group: "Group Adventure" }
];
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center text-center my-12 px-4 w-full max-w-6xl mx-auto bg-gradient-to-b from-[#F1FDF3] to-white rounded-lg shadow-lg p-8">
        ...
        >
          Tucked away in the Eastern Himalayas, Sikkim is a paradise of snow-capped mountains, cascading waterfalls, ancient monasteries, and vibrant culture. Often called the “Gateway to the Northeast”, Sikkim is one of India’s most peaceful and picturesque states. With its clean surroundings, warm-hearted people, and breathtaking landscapes, it offers an ideal escape for nature lovers, honeymooners, and adventure seekers alike.
        </motion.p>
        <div
          ref={contentRef}
          ...
          <div className="py-6 space-y-8">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Sikkim is a land of mesmerizing beauty, where every turn opens to a new surprise. The mighty Kanchenjunga, the world’s third-highest peak, dominates the skyline and adds to the state’s divine charm. The capital city, Gangtok, blends tradition with modernity — offering scenic views, lively markets, and spiritual calm.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-green-900 mb-4">Must-Visit Destinations in Sikkim</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li><strong>Gangtok</strong>: The capital city, known for its stunning views, monasteries, MG Marg, and the ropeway ride.</li>
                <li><strong>Tsomgo Lake</strong>: A glacial lake surrounded by snow-capped peaks, known for its mesmerizing beauty.</li>
                <li><strong>Nathula Pass</strong>: A high-altitude mountain pass on the Indo-China border, offering breathtaking views and a sense of pride.</li>
                <li><strong>Lachung & Yumthang Valley</strong>: The “Valley of Flowers,” famous for its alpine meadows and colorful blooms.</li>
                <li><strong>Pelling</strong>: A serene town offering panoramic views of Kanchenjunga and beautiful monasteries.</li>
                <li><strong>Ravangla & Namchi</strong>: Known for their giant Buddha statues, peaceful vibes, and scenic hill views.</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-green-900 mb-4">Adventure and Thrills in Sikkim</h3>
              <p className="text-gray-600 leading-relaxed">
                The crystal-clear lakes, lush forests, and colorful valleys make Sikkim a haven for travelers seeking tranquility and connection with nature. From the peaceful monasteries of Rumtek and Pemayangtse to the adventure trails of Yumthang Valley, Sikkim has something special for everyone.
              </p>
            </div>
          </div>
        </div>
